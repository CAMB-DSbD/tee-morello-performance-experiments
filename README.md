...
# 1. pdf version   
  ...
  [pdf version ](https://github.com/CAMB-DSbD/tee-morello-performance-experiments/blob/main/documents/library_based_compartments_evaluation.pdf) can be downloaded.
It might be slightly behind this page.   
